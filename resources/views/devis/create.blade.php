...
<!-- <img src="/couvreurs1.jpg"> -->
 <br><br><br>
<div class="max-w-lg mx-auto bg-white mt-10 rounded-lg p-6">
    ...
      <label for="no">Non</label><br>
        ...
        <div>
            ...
            <textarea name="message" rows="5" class="w-full border rounded p-2" required>{{ old('message') }}</textarea> <!--dark:border?-->
            @error('message') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
        </div>

         <button type="submit" class="bg-blue-400 text-black px-4 py-2 rounded font-bold hover:bg-blue-500 hover:cursor-pointer transition-colors duration-200">
            Envoyer
        </button>
    </form>
    <br>
