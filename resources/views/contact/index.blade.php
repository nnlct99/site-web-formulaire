...
<div class="max-w-lg mx-auto bg-white shadow-md border rounded-lg p-6">
    ...
    <form action="{{ route('contact.store') }}" method="POST" class="space-y-4">
        ...
        <div style="display: none;" id="d">
            <label for="appointment" class="block font-medium">Date et heure du rendez-vous</label>
            <input 
                type="datetime-local" 
                name="appointment" 
                id="appointment"
        ...
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded border hover:bg-blue-700">
            Envoyer
        </button>
    </form>
</div>
